...
test_that("Non-cumulative", {
  ...
  result <- getFeatureExtractionDefaultTimeWindows(cumulative)
...
test_that("Period Types", {
  ...
  result <- getFeatureExtractionDefaultTimeWindows(cumulative, periodTypes)
  expect_equal(result, expected)
})
...
test_that("Selected Cumulative", {
  ...
  result <- getFeatureExtractionDefaultTimeWindows(selectedcumulative = selectedCumulative)
  expect_equal(result, expected)
})
