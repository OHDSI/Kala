...
test_that("StdDiff Error 1)", {
  ...
  expect_message(getFeatureExtractionStandardizedDifference(covariateData1Path = system.file("testdata", "covariateData_cohortId_1.zip", package = "Kala"),
                                                        covariateData2Path = system.file("testdata", "covariateData_cohortId_4.zip", package = "Kala"), 
                                                        cohortId1 = 1, cohortId2 = 4, timeRef = NULL, includeNonTimeVarying = FALSE), "includeNonTimeVarying is FALSE and timeRef is NULL. no results.")
...
test_that("StdDiff Error 2)", {
  ...
  expect_error(getFeatureExtractionStandardizedDifference(covariateData1Path = NULL,
                                                            covariateData2Path = NULL, 
                                                            cohortId1 = 1, cohortId2 = 4, timeRef = timeRef), "covariateData1/2 and path are all NULL")
...
test_that("StdDiff Error 3)", {
  ...
  expect_error(getFeatureExtractionStandardizedDifference(covariateData1Path = system.file("testdata", "covariateData_cohortId_1.zip", package = "Kala"),
                                                            covariateData2Path = system.file("testdata", "covariateData_cohortId_4.zip", package = "Kala"), 
                                                            cohortId1 = 1, cohortId2 = 4, timeRef = timeRef), "please check timeRef")
